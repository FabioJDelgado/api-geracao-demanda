...
public record JogadaRegistroRequestDto(
        ...
        double preco,
        @NotBlank(message = "A capacidade instalada não pode ser vazia ou nula e deve ser um dos valores: CAPACIDADEINSTALADA1, CAPACIDADEINSTALADA2 ou CAPACIDADEINSTALADA3")
        @ValidaEnum(enumClass = CapacidadeInstalada.class, message = "A capacidade instalada deve ser um dos valores: CAPACIDADEINSTALADA1, CAPACIDADEINSTALADA2 ou CAPACIDADEINSTALADA3", casosIgnorados = false)
