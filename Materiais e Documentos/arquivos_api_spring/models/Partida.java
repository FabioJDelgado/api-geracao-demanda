...
public class Partida implements Serializable {
    ...
    */
    ...
    /*public int calculaDemandaTotalJogadaPartida(String identificacaoRodada){
        int soma = 0;
        for(Rodada rodada : rodadas){
            for (Jogada jogada : rodada.getJogadas()){
                if(jogada.getIdentificacaoJogada().equals(identificacaoRodada)) {
                    soma += jogada.getDemandaTotalJogada();
                }
            }
        }
        return soma;
