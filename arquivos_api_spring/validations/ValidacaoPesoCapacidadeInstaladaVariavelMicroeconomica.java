...
public class ValidacaoPesoCapacidadeInstaladaVariavelMicroeconomica  implements ConstraintValidator<ValidaPesoCapacidadeInstaladaVariavelMicroeconomica, Map<String, Double>> {

    @Override
    public boolean isValid(Map<String, Double> pesosCapacidadeInstalada, ConstraintValidatorContext context) {
        List<ErroInfo> erros = new ArrayList<>();
        boolean isValid = true;
        String msgErro = "";

        for(Map.Entry<String, Double> entry : pesosCapacidadeInstalada.entrySet()){
