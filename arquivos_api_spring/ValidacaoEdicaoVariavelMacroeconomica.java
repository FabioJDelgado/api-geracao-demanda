...
public class ValidacaoEdicaoVariavelMacroeconomica implements ConstraintValidator<ValidaEdicaoVariavelMacroeconomica, VariavelMacroeconomicaEditarResponseDto> {


    @Override
    public boolean isValid(VariavelMacroeconomicaEditarResponseDto dto, ConstraintValidatorContext context) {
