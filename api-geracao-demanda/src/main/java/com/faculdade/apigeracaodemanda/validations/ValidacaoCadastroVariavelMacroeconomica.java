...
public class ValidacaoCadastroVariavelMacroeconomica implements ConstraintValidator<ValidaCadastroVariavelMacroeconomica, VariavelMacroeconomicaCadastroRequestDto> {


    @Override
    public boolean isValid(VariavelMacroeconomicaCadastroRequestDto dto, ConstraintValidatorContext context) {
